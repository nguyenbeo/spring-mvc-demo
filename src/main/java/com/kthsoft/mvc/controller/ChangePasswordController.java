...
public class ChangePasswordController {
	...
	public String savePassword(@ModelAttribute("changePasswordForm")  @Valid ChangePasswordForm changePasswordForm,
			Model model) {
		model.addAttribute("currentPassword", changePasswordForm.getCurrentPassword());
	...
	public String testExceptionHandling() {
		throw new RuntimeException("Just wanna test the exception handling feature");
	}
}
